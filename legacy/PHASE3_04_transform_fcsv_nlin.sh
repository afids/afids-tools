#!/bin/bash
# nonlinear transform of point fcsv files
...
output_dir=~/GitHub/afids-analysis/data/PHASE3_output_afid_nlin/
...
while read SUBJ; do
  ...
  output_fcsv=${output_dir}/OAS1_${input_subj_id}_MR1_T1_MEAN_transformed_nlin.fcsv
  ...
  python3 ~/GitHub/sandbox/antsApplyH5TransformsToSlicerFCSV.py -i $input_fcsv -o $output_fcsv -f $input_warp_to_MNI152 -b $input_warp_to_MNI152_inv
